...
public class VacancyControllerTest {
    ...
    @Test
    public void whenFindVacancyByIdThenPageOne() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    public void whenUpdateVacancyThenRedirectVacanciesPage() throws IOException {
        var updatedVacancy = new Vacancy(1, "updatedVacancy", "updatedVacancy", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        ...
        assertThat(view).isEqualTo("redirect:/vacancies");
        assertThat(updatedVacancy).usingRecursiveComparison().isEqualTo(actualVacancy);
        assertThat(fileDto).usingRecursiveComparison().isEqualTo(actualFileDto);
    }

    @Test
    public void whenNotUpdatedVacancyThenGetErrorPage() {
    ...
    @Test
    public void whenDeletedVacancyThenGetVacanciesPage() {
        int id = 1;
    ...
    @Test
    public void whenNotDeletedVacancyThenGetErrorPage() {
        int id = 1;
